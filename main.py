...
from pydantic import BaseModel, List, Optional, Dict, Any # Ensure all are here
# from typing import Optional # This is covered by pydantic.Optional
...
class BiasAnalysisModel(BaseModel):
    ...
    ml_model_confidence: Optional[float] = None # Confidence of the ML bias type if ML is source
...
# --- Existing/Reused Models (Ensure they are correctly defined as per previous steps) ---
...
class DetailedSubAnalysesModel(BaseModel):
    ...
    bias: Optional[Dict[str, Any]] = None # Full ML bias model output
    patterns: Optional[Dict[str, Any]] = None
    lightweight_nigerian_bias: Optional[LightweightNigerianBiasAssessmentModel] = None # Full lightweight assessment
...
class AnalyzeResponseModel(BaseModel):
    ...
    lightweight_nigerian_bias_assessment: Optional[LightweightNigerianBiasAssessmentModel] = None # Retained at top level
    detailed_sub_analyses: Optional[DetailedSubAnalysesModel] = None

# --- Pydantic Model for /quick_analyze Response ---
class QuickAnalysisResponseModel(BaseModel):
    score: Optional[float] = None
    indicator: Optional[str] = None
    explanation: Optional[str] = None
    tip: Optional[str] = None
    inferred_bias_type: Optional[str] = None # This is from lightweight_nigerian_bias_assessment
    bias_category: Optional[str] = None
    bias_target: Optional[str] = None
    matched_keywords: Optional[List[str]] = None
